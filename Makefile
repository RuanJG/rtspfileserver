###############################################
#OpenWrt Makefile for tcptouart program
##############################################
include $(TOPDIR)/rules.mk
# Name and release number of this package
PKG_NAME:=rtspfileserver
PKG_RELEASE:=1
...
define Package/rtspfileserver
	SECTION:=utils
	CATEGORY:=Utilities
	TITLE:=rtspfileserver -- for tcp uart user
	DEPENDS:=+libc +libpthread +libstdcpp
endef
# Uncomment portion below for Kamikaze and delete DESCRIPTION variable above
define Package/tcptouart/description
...
$(eval $(call BuildPackage,rtspfileserver))
